          ...
          client.query(sql, function(err, result) {
            ...
            if (err) {
              ...
              if (result.rows[0]) {
                ...
                var sql = `update ${skill_table_name} set player_name = $$${player_name}$$, guitar_skill = $$${guitar_data_str}$$, drum_skill = $$${drum_data_str}$$, update_date = $$${update_date}$$, update_count = ${(result
